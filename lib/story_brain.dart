...
class StoryBrain {
  ...
  void nextStory(int choiceNumber) {
    if (choiceNumber == 1 && _sNum == 0) {
      _sNum = 2;
    } else if (choiceNumber == 2 && _sNum == 0) {
      _sNum = 1;
    } else if (choiceNumber == 1 && _sNum == 1) {
      _sNum = 2;
    } else if (choiceNumber == 2 && _sNum == 1) {
      _sNum = 3;
    } else if (choiceNumber == 1 && _sNum == 2) {
      _sNum = 5;
    } else if (choiceNumber == 2 && _sNum == 2) {
      _sNum = 4;
